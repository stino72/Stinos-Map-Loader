...
2. (optinal but recommened) Copy all textures into the mod folder (in the same place they are in a trailmappers export)
...
5. (optinal) Delete the old MAP file from the trailmappers export
6. Replace the main.lua file in the trailmappers export with the main.lua file in /data_dynamic/<map name>/
7. (optinal) Delete the LoadIcon.png since this map loader doesn't use into
8. Load the map
